...
const shequs = [
    new Shequ(1,'http://usercontent.edu2act.cn/media/userheader/17-07-18/KbeV987Y2GWmTnUD76Jzan.jpg?imageView2/1/w/256/h/256','http://usercontent.edu2act.cn/media/ckeditor/upload2018/0930/5WounpUrmbfrtEVquzw5De.jpg','web开发二——函数',
    "（一）函数三要素</p><p>函数的三要素为函数名、参数（形参，实参），返回值。（二）函数定义与调用</p><p>函数定义的关键字为function，不能省略，也不要能简写。定义函数有3种形式，相应的调用形式有2种。1．函数声明形式注： 不需要在函数声明的后面添加一个分号，并且添加一个分号完全是浪费性能。大括号是函数声明的必须的语法元素之一，同时它也是一个复合语句，可以用来组织语句，右侧的花括弧( </强>} <strong>)本身就意味着复合语句的结束，所以不用添加分号，如果添加分号的话，就相当于重新建立了一个空语句。"
    ...
    '刘秀梅','2018-10-11 15:10',344,2),
    new Shequ(2,'http://usercontent.edu2act.cn/media/userheader/15-11-10/8pt3Ph9aDFbAveubDWgN5Y.jpg?imageView2/1/w/256/h/256','http://usercontent.edu2act.cn/media/ckeditor/upload2018/0930/3RtZyjoCHuFQSyZCWgr2o5.jpg','数据结构',
    "（一）函数三要素</p><p>函数的三要素为函数名、参数（形参，实参），返回值。（二）函数定义与调用</p><p>函数定义的关键字为function，不能省略，也不要能简写。定义函数有3种形式，相应的调用形式有2种。1．函数声明形式注： 不需要在函数声明的后面添加一个分号，并且添加一个分号完全是浪费性能。大括号是函数声明的必须的语法元素之一，同时它也是一个复合语句，可以用来组织语句，右侧的花括弧( </强>} <strong>)本身就意味着复合语句的结束，所以不用添加分号，如果添加分号的话，就相当于重新建立了一个空语句。"
    +"2．函数表达式形式所以一般写成下列形式：注： 函数表达式和声明变量原理相同，只不过变量的值是一个函数对象，这个时候就建议使用分号结尾。3．匿名函数匿名函数需要立即调用或者立即赋值给一个变量，上述代码为立即调用，而函数表达式为匿名函数立即赋值给一个变量的形式，事件也是。（三）匿名函数匿名函数为什么要加一对小括号呢？这样使用有什么好处么？1．在function前面加！、+、 - 甚至是逗号等到都可以起到函数定义后立即执行的效果，而（）、！、+、-、=等运算符，"
    +"<strong>都将函数声明转换成函数表达式，消除了javascript引擎识别函数表达式和函数声明的歧义</强>，告诉javascript引擎这是一个函数表达式，不是函数声明，可以在后面加括号，并立即执行函数的代码。2．函数是有返回值的，返回我们指定的值或者undefined。函数的返回值我们可能需要在后续中使用。在函数前面加上不同的运算符，这些运算符还会和函数的返回值进行运算，有时造成不必要的麻烦。"
    +"在这些运算符中加括号是最安全的做法，因为它不会改变函数的返回值。至此，我们回答了第一个问题。接下来我们回答第二个问题：匿名函数的好处。javascript中没用私有作用域的概念，在ES5中只用全局作用域和局部作用域"
    ...
    +"第一是提升变量，第二是执行JavaScript语句。这两个知识点结合在一起，我们看下列代码：调用add(1,2) 语句执行结果为：我们看到add函数运行时没有报错，"
    +"并且只有第一个console.log（c）执行，且输出为undefined。<br>结果分析：因为第一步为变量提升，所以相当于为如下代码：在第二步add函数代码运行到第一个console.log(c)时，变量c已经声明但是没有赋值，所以输出undefined，而return语句后面的c=5;console.log(c)语句不会被执行。注：如有疑问，欢迎指正",
    '杨伟斌','2018-10-21 17:10',34,266),
    new Shequ(3,'http://usercontent.edu2act.cn/media/userheader/18-06-11/hcnaQiW74323X9xzQNu8pR.jpg?imageView2/1/w/256/h/256','http://usercontent.edu2act.cn/media/ckeditor/upload2018/0930/ZVukV3kKu2r8b9ezbbc5VA.jpg','栈和队列之间的相互转换',
    "（一）函数三要素</p><p>函数的三要素为函数名、参数（形参，实参），返回值。（二）函数定义与调用</p><p>函数定义的关键字为function，不能省略，也不要能简写。定义函数有3种形式，相应的调用形式有2种。1．函数声明形式注： 不需要在函数声明的后面添加一个分号，并且添加一个分号完全是浪费性能。大括号是函数声明的必须的语法元素之一，同时它也是一个复合语句，可以用来组织语句，右侧的花括弧( </强>} <strong>)本身就意味着复合语句的结束，所以不用添加分号，如果添加分号的话，就相当于重新建立了一个空语句。"
    +"2．函数表达式形式所以一般写成下列形式：注： 函数表达式和声明变量原理相同，只不过变量的值是一个函数对象，这个时候就建议使用分号结尾。3．匿名函数匿名函数需要立即调用或者立即赋值给一个变量，上述代码为立即调用，而函数表达式为匿名函数立即赋值给一个变量的形式，事件也是。（三）匿名函数匿名函数为什么要加一对小括号呢？这样使用有什么好处么？1．在function前面加！、+、 - 甚至是逗号等到都可以起到函数定义后立即执行的效果，而（）、！、+、-、=等运算符，"
    +"<strong>都将函数声明转换成函数表达式，消除了javascript引擎识别函数表达式和函数声明的歧义</强>，告诉javascript引擎这是一个函数表达式，不是函数声明，可以在后面加括号，并立即执行函数的代码。2．函数是有返回值的，返回我们指定的值或者undefined。函数的返回值我们可能需要在后续中使用。在函数前面加上不同的运算符，这些运算符还会和函数的返回值进行运算，有时造成不必要的麻烦。"
    +"在这些运算符中加括号是最安全的做法，因为它不会改变函数的返回值。至此，我们回答了第一个问题。接下来我们回答第二个问题：匿名函数的好处。javascript中没用私有作用域的概念，在ES5中只用全局作用域和局部作用域"
    ...
    +"第一是提升变量，第二是执行JavaScript语句。这两个知识点结合在一起，我们看下列代码：调用add(1,2) 语句执行结果为：我们看到add函数运行时没有报错，"
    +"并且只有第一个console.log（c）执行，且输出为undefined。<br>结果分析：因为第一步为变量提升，所以相当于为如下代码：在第二步add函数代码运行到第一个console.log(c)时，变量c已经声明但是没有赋值，所以输出undefined，而return语句后面的c=5;console.log(c)语句不会被执行。注：如有疑问，欢迎指正",
    '7-李建涛','2018-10-01 12:51',42,2),
    new Shequ(4,'http://usercontent.edu2act.cn/media/userheader/17-07-18/KbeV987Y2GWmTnUD76Jzan.jpg?imageView2/1/w/256/h/256','http://usercontent.edu2act.cn/media/ckeditor/upload2018/0930/5WounpUrmbfrtEVquzw5De.jpg','web开发二——函数',
    "（一）函数三要素</p><p>函数的三要素为函数名、参数（形参，实参），返回值。（二）函数定义与调用</p><p>函数定义的关键字为function，不能省略，也不要能简写。定义函数有3种形式，相应的调用形式有2种。1．函数声明形式注： 不需要在函数声明的后面添加一个分号，并且添加一个分号完全是浪费性能。大括号是函数声明的必须的语法元素之一，同时它也是一个复合语句，可以用来组织语句，右侧的花括弧( </强>} <strong>)本身就意味着复合语句的结束，所以不用添加分号，如果添加分号的话，就相当于重新建立了一个空语句。"
    +"2．函数表达式形式所以一般写成下列形式：注： 函数表达式和声明变量原理相同，只不过变量的值是一个函数对象，这个时候就建议使用分号结尾。3．匿名函数匿名函数需要立即调用或者立即赋值给一个变量，上述代码为立即调用，而函数表达式为匿名函数立即赋值给一个变量的形式，事件也是。（三）匿名函数匿名函数为什么要加一对小括号呢？这样使用有什么好处么？1．在function前面加！、+、 - 甚至是逗号等到都可以起到函数定义后立即执行的效果，而（）、！、+、-、=等运算符，"
    +"<strong>都将函数声明转换成函数表达式，消除了javascript引擎识别函数表达式和函数声明的歧义</强>，告诉javascript引擎这是一个函数表达式，不是函数声明，可以在后面加括号，并立即执行函数的代码。2．函数是有返回值的，返回我们指定的值或者undefined。函数的返回值我们可能需要在后续中使用。在函数前面加上不同的运算符，这些运算符还会和函数的返回值进行运算，有时造成不必要的麻烦。"
    +"在这些运算符中加括号是最安全的做法，因为它不会改变函数的返回值。至此，我们回答了第一个问题。接下来我们回答第二个问题：匿名函数的好处。javascript中没用私有作用域的概念，在ES5中只用全局作用域和局部作用域"
    ...
    +"并且只有第一个console.log（c）执行，且输出为undefined。<br>结果分析：因为第一步为变量提升，所以相当于为如下代码：在第二步add函数代码运行到第一个console.log(c)时，变量c已经声明但是没有赋值，所以输出undefined，而return语句后面的c=5;console.log(c)语句不会被执行。注：如有疑问，欢迎指正",
    '刘秀梅','2018-10-11 15:10',344,2),
    new Shequ(5,'http://usercontent.edu2act.cn/media/userheader/15-11-10/8pt3Ph9aDFbAveubDWgN5Y.jpg?imageView2/1/w/256/h/256','http://usercontent.edu2act.cn/media/ckeditor/upload2018/0930/3RtZyjoCHuFQSyZCWgr2o5.jpg','数据结构',
    "（一）函数三要素</p><p>函数的三要素为函数名、参数（形参，实参），返回值。（二）函数定义与调用</p><p>函数定义的关键字为function，不能省略，也不要能简写。定义函数有3种形式，相应的调用形式有2种。1．函数声明形式注： 不需要在函数声明的后面添加一个分号，并且添加一个分号完全是浪费性能。大括号是函数声明的必须的语法元素之一，同时它也是一个复合语句，可以用来组织语句，右侧的花括弧( </强>} <strong>)本身就意味着复合语句的结束，所以不用添加分号，如果添加分号的话，就相当于重新建立了一个空语句。"
    +"2．函数表达式形式所以一般写成下列形式：注： 函数表达式和声明变量原理相同，只不过变量的值是一个函数对象，这个时候就建议使用分号结尾。3．匿名函数匿名函数需要立即调用或者立即赋值给一个变量，上述代码为立即调用，而函数表达式为匿名函数立即赋值给一个变量的形式，事件也是。（三）匿名函数匿名函数为什么要加一对小括号呢？这样使用有什么好处么？1．在function前面加！、+、 - 甚至是逗号等到都可以起到函数定义后立即执行的效果，而（）、！、+、-、=等运算符，"
    +"<strong>都将函数声明转换成函数表达式，消除了javascript引擎识别函数表达式和函数声明的歧义</强>，告诉javascript引擎这是一个函数表达式，不是函数声明，可以在后面加括号，并立即执行函数的代码。2．函数是有返回值的，返回我们指定的值或者undefined。函数的返回值我们可能需要在后续中使用。在函数前面加上不同的运算符，这些运算符还会和函数的返回值进行运算，有时造成不必要的麻烦。"
    +"在这些运算符中加括号是最安全的做法，因为它不会改变函数的返回值。至此，我们回答了第一个问题。接下来我们回答第二个问题：匿名函数的好处。javascript中没用私有作用域的概念，在ES5中只用全局作用域和局部作用域"
    ...
    +"并且只有第一个console.log（c）执行，且输出为undefined。<br>结果分析：因为第一步为变量提升，所以相当于为如下代码：在第二步add函数代码运行到第一个console.log(c)时，变量c已经声明但是没有赋值，所以输出undefined，而return语句后面的c=5;console.log(c)语句不会被执行。注：如有疑问，欢迎指正",
    '杨伟斌','2018-10-21 17:10',34,266),
    new Shequ(6,'http://usercontent.edu2act.cn/media/userheader/18-06-11/hcnaQiW74323X9xzQNu8pR.jpg?imageView2/1/w/256/h/256','http://usercontent.edu2act.cn/media/ckeditor/upload2018/0930/ZVukV3kKu2r8b9ezbbc5VA.jpg','栈和队列之间的相互转换',
    "（一）函数三要素</p><p>函数的三要素为函数名、参数（形参，实参），返回值。（二）函数定义与调用</p><p>函数定义的关键字为function，不能省略，也不要能简写。定义函数有3种形式，相应的调用形式有2种。1．函数声明形式注： 不需要在函数声明的后面添加一个分号，并且添加一个分号完全是浪费性能。大括号是函数声明的必须的语法元素之一，同时它也是一个复合语句，可以用来组织语句，右侧的花括弧( </强>} <strong>)本身就意味着复合语句的结束，所以不用添加分号，如果添加分号的话，就相当于重新建立了一个空语句。"
    +"2．函数表达式形式所以一般写成下列形式：注： 函数表达式和声明变量原理相同，只不过变量的值是一个函数对象，这个时候就建议使用分号结尾。3．匿名函数匿名函数需要立即调用或者立即赋值给一个变量，上述代码为立即调用，而函数表达式为匿名函数立即赋值给一个变量的形式，事件也是。（三）匿名函数匿名函数为什么要加一对小括号呢？这样使用有什么好处么？1．在function前面加！、+、 - 甚至是逗号等到都可以起到函数定义后立即执行的效果，而（）、！、+、-、=等运算符，"
    +"<strong>都将函数声明转换成函数表达式，消除了javascript引擎识别函数表达式和函数声明的歧义</强>，告诉javascript引擎这是一个函数表达式，不是函数声明，可以在后面加括号，并立即执行函数的代码。2．函数是有返回值的，返回我们指定的值或者undefined。函数的返回值我们可能需要在后续中使用。在函数前面加上不同的运算符，这些运算符还会和函数的返回值进行运算，有时造成不必要的麻烦。"
    +"在这些运算符中加括号是最安全的做法，因为它不会改变函数的返回值。至此，我们回答了第一个问题。接下来我们回答第二个问题：匿名函数的好处。javascript中没用私有作用域的概念，在ES5中只用全局作用域和局部作用域"
...
app.get('/api/courses/:id',(req,res)=>{
    req.params
    res.json(courses.find((ele)=>ele.id == req.params.id));        //获得当前元素集合中每个元素的后代
});
